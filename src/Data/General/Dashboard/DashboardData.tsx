...
import { CustomApexOptions, CustomComponentProps, LeadsStatusProps, OnlineOrderCardTypes, RecentOrderTableProps } from "@/Types/DashboardType";
...
export const ProjectOptions: CustomApexOptions = {
  series: [{
      ...
      name: 'TEAM B',
      type: 'area',
      data: [210, 90, 240, 100, 200, 120, 200, 80, 260, 120, 210, 90, 240, 100, 250, 40, 200, 40, 220, 220]
  }],
  chart: {
      height: 355,
      type: 'area',
