...
import { AdditionalDescription, AdditionalTagTitle, MdeEditorText, SpecificTags } from "@/Constant/constant";
            ...
            <Row className="g-3">
              ...
              <Col sm="6">
                <Row className="product-tag">
                  ...
                  <Col xs="12">
                    <Typeahead id="multiple-typeahead" labelKey="name" options={MultiWithHeaderData} multiple clearButton />
                  </Col>
                </Row>
              </Col>
              <Col xs="12">
