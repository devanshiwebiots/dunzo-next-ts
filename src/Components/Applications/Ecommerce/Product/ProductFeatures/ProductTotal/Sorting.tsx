...
import { Featured, HighestPrices, LowestPrices } from "@/Constant/constant";
  ...
  return (
    <Col md="6" className="text-sm-end">
      ...
      <div className="select2-drpdwn-product select-options d-inline-block" onChange={filterSort}>
        <select className="form-control btn-square shadow-none custom-scrollbar form-select" name="select">
