  ...
  return (
    <div className="modal-toggle-wrapper">
      <ul className="modal-img">
        <li><Image priority width={100} height={100} src={`${ImagePath}/gif/whatapp.gif`} alt="whatsapp" unoptimized/></li>
        <li><Image priority width={100} height={100} src={`${ImagePath}/gif/instagram.gif`} alt="instagram" unoptimized/></li>
        <li><Image priority width={100} height={100} src={`${ImagePath}/gif/facebook.gif`} alt="facebook" unoptimized/></li>
      </ul>
