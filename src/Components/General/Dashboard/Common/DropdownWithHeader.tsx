...
export const DropdownWithHeader: React.FC<CommonHeaderWithDropdownProps> = ({ heading, dropDownList, headerClass, headingClass, dropDownTitle, caret, dropDownClass, dropDownIcon }) => {
